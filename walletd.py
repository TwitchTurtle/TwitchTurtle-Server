...
class Walletd:
    ...
    def get_transaction(self, address):
        params = {
                  ...
                  'blockCount': 20000000000
                  }
        return self._make_request('getTransactions', **params)

    def get_transactions(self, first_block_index, block_count):
        params = {
    ...
    def send_transaction(self, transfers, anonymity=3, fee=10,
        ...
        if payment_id and extra:
            ...
            params['extra'] = "7b226e616d65223a20225769746864726177616c222c226d657373616765223a20225769746864726177616c227d"
